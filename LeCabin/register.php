...
$title = "Página de Registro de Clientes del Salón de Estética Le Cabín";
...
if (isset($_POST["username"])) // Si se reciben los datos por POST.
{
    ...
    if (!$already) // Si no están en la base de datos ni E-mail ni Teléfono.
    {
        ...
        $conn = null;
        echo "<script>toast(0, 'Cliente Agregado', 'Te damos la Bienvenida $name, Gracias por Registarte como Cliente en el Salón de Estética Le Cabín.');</script>";
