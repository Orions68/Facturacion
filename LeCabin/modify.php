...
$title = "Salón de Estética Le Cabín - Modificando los datos del Cliente";
...
if (isset($_POST["username"])) // Si llegan datos por post.
{
    ...
    {
        echo "<script>toast(1, 'Ya Registrado:', 'El E-mail $email o el Teléfono $phone, ya Están Registrados en Este Sitio. Ingresa con tu E-mail y Contraseña, Si no Recuerdas tu Contraseña Puedes Recuperarla en la Página de Entrada de Cliente.');</script>"; // Muestro el error, el E-mail, etc. ya están registrados.
    }
}
?>
</body>
