...
include "getdata.php";
$title = "Facturación de Salón de Estética Le Cabín";
        ...
        <div class="col-md-1" style="width: 2%;"></div>
            <div class="col-md-10">
                <div id="view1">
					...
					<h3>Le Cabin - Johana Llinas Dorta - C.I.F 20-42506157-3</h3>
                    ...
                    <div style="width: 1px;"></div>
                        ...
                        echo '</div>
                        <div class="column moreright" style="background-color:#e0e0e0; text-align:right;">';
                        echo number_format((float)$total * 100 / 107, 2, ',', '.') . " €";
                        echo '</div>
                        <div class="column moreright" style="background-color:#e8e8e8; text-align:right;">';
                        echo number_format((float)$total * 100 / 107 * .07, 2, ',', '.') . ' €';
                        echo '</div>
                        <div class="column moreright" style="background-color:#efefef; text-align:right;">';
					...
					<div class="row">
                    <div class="column total" style="background-color:#000; text-align:right; color:white; margin-left:32%">Total I.G.I.C. Incluido: ' . number_format((float)$total, 2, ',', '.') . ' €</div>
					</div></div>
